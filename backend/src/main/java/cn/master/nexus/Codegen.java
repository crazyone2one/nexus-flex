...
public class Codegen {
    public static void main(String[] args) {
        ...
        dataSource.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/nexus-flex?useInformationSchema=true&characterEncoding=utf-8");
    ...
    public static GlobalConfig createGlobalConfigUseStyle1(String tableName) {
        ...
        //设置根包
        globalConfig.getPackageConfig().setBasePackage("cn.master.nexus.modules.system");
