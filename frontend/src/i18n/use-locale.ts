...
import {loadLocalePool, type LocaleType} from '/@/i18n/helper.ts';
...
const setI18nLanguage = (locale: LocaleType) => {
    ...
    localStorage.setItem('NF-locale', locale);
}
const changeLocale = async (locale: LocaleType) => {
    ...
    window.$message?.loading(currentLocale === 'zh-CN' ? '语言切换中...' : 'Language switching...');
